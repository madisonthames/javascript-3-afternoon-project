...
function removeDuplicates() {
  for (var i=workplaceAccidents.length - 1; i > 0; i--) {
    for (var x=0; x < workplaceAccidents.length; x++) {
        console.log(workplaceAccidents[i], workplaceAccidents[x])
      if (workplaceAccidents[i] === workplaceAccidents[x] && i !== x) { 
...
function looper() {
  for (i=0;i<numsArr.length;i++){
    for (nesti = 0; nesti < numsArr[i].length; nesti++){
      if (numsArr[i][nesti] % 2 === 0){
